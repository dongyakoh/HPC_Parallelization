...
q_flag      = 0    # 0: med16core, 1: onenode16core, 2: mem768GB32core
...
for idx_core, num_core in enumerate(list_cores):
    ...
    file_name0 = "runtime_vfi_by_cores_chunks" + oop_var + "_1_" + str(max_core) + "_" + str(num_core) + ".txt"
    ...
    file_out_name = "runtime_vfi_by_cores_chunks" + oop_var + q_var + "_" + str(num_core) + ".txt"
